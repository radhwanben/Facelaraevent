      ...
      <div class="row">
        <div class="top-bar-left">
          <ul class="dropdown menu" data-dropdown-menu="tckp8q-dropdown-menu" role="menubar">
            ...
            <li role="menuitem"><a href="{{ route('events') }}">events</a></li>
          </ul>
        </div>
    ...
    <script>
      $(document).foundation();
        ...
        <script>
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwZ9tOBt6ImNdkgOcgvJuCzZeU5T1pueY&libraries=places&callback=activatePlaces"></script>
    </body>
</html>
